...
| коментарі | **українською** — вони пояснюють «чому», і власник їх читає |
...
виклик `t("state.head")`. Дашборд i18n не має взагалі, українське вшите в усіх
52 файлах — **не додавай до цього боргу**. Подробиці в `AGENTS.md`, розділ 5.
