...
const uk = {
  ...
  'tool.web_search': 'Пошук у мережі',
  'tool.image_search': 'Пошук картинок',
  'tool.facts': 'Довідка',
  'tool.weather': 'Погода',
  'tool.currency': 'Курс валют',
  'tool.memory_search': 'Памʼять',
  'tool.workspace_read': 'Читання файлу',
  'tool.workspace_write': 'Запис у файл',
  'tool.workspace_list': 'Тека',
  'tool.workspace_show': 'Файл',
  'tool.ask_question': 'Запитання',
  'tool.todo_list': 'Список',
  'tool.show_choice': 'Вибір',
  'tool.play_music': 'Музика',
  'tool.play_video': 'Відео',
  'tool.logs': 'Журнал',
  'tool.signIn': 'Потрібен вхід',
...
const en: Record<keyof typeof uk, string> = {
  ...
  'tool.currency': 'Exchange rate',
  'tool.memory_search': 'Memory',
  'tool.workspace_read': 'Read file',
  'tool.workspace_write': 'Write file',
  'tool.workspace_list': 'Folder',
  'tool.workspace_show': 'File',
  'tool.ask_question': 'Question',
  'tool.todo_list': 'List',
  'tool.show_choice': 'Choice',
  'tool.play_music': 'Music',
  'tool.play_video': 'Video',
  'tool.logs': 'Logs',
  'tool.signIn': 'Sign-in needed',
