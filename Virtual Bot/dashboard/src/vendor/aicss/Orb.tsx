/*
 * Джерело: https://www.aicss.dev/r/orbs.json (реєстр shadcn).
 *
 * Змінено тільки одне: прибрано чотири мертві оголошення (`ring` у
 * `cellDelay`, `shapeOctagon`, `SCATTER_TRAIL`, невживаний параметр `j`) —
 * на них не посилається ніщо, а в нас увімкнені noUnusedLocals /
 * noUnusedParameters, і без цього не збирається весь проєкт. Логіка,
 * геометрія та CSS-модуль — як в оригіналі.
 */
"use client";
