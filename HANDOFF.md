...
**Екран пристрою (`/screen`):** окремий vanilla UI 320×240 із каруселлю тайлів, шторкою швидких дій та Android-подібною шухлядою застосунків (5 колонок, Камера, Сервіси, локальна Панель і Налаштування без переходу на `/`). У Налаштуваннях реально працюють тема, яскравість, голос/гучність, вибір Piper-голосу та три стилі іконок: піксельні «наші», однотонні з вибором кольору й окремо кольорові. Стрічка подій прибрана; свайп угору відкриває шухляду.
