...
const DICT = {
  uk: {
    ...
    "voice.yes": "так?",
    "voice.stopped": "добре, мовчу",
    "voice.recognizing": "(розпізнаю…)",
    "voice.asrFail": "Розпізнавання недоступне",
    "voice.asrOffline": "Бот недоступний — мову не розпізнано",
    ...
    /* ---- що бот РОБИТЬ просто зараз (між «розпізнав» і відповіддю) ----
       Без цього після фрази екран мовчав: людина не знала, чи бот думає,
       чи взагалі не почув. Ключі tool.* — назви інструментів; те, ЩО саме
       шукається чи читається, приходить з бекенда в події tool_progress. */
    "busy.thinking": "думаю…",
    "busy.working": "працюю…",
    "busy.answering": "відповідаю…",
    "busy.tool.weather": "дивлюсь погоду",
    "busy.tool.currency": "дивлюсь курс",
    "busy.tool.facts": "шукаю у Вікіпедії",
    "busy.tool.web_search": "шукаю в інтернеті",
    "busy.tool.image_search": "шукаю картинки",
    "busy.tool.memory_search": "шукаю в памʼяті",
    "busy.tool.workspace_info": "дивлюсь робочу теку",
    "busy.tool.workspace_list": "дивлюсь теку",
    "busy.tool.workspace_read": "читаю файл",
    "busy.tool.workspace_write": "пишу файл",
    "busy.tool.workspace_mkdir": "створюю теку",
    "busy.tool.workspace_delete": "прибираю в кошик",
    "busy.tool.create_brain_file": "записую в памʼять",
    "busy.tool.create_brain_directory": "створюю розділ памʼяті",
    "busy.tool.list_brain_navigation": "переглядаю памʼять",
    ...
    "quick.chatNew": "Новий чат",
    "quick.chatPick": "Змінити чат",
    "quick.full": "На весь",
    ...
    "timer.head": "Таймер",
    "timer.empty": "Скажи «постав таймер на 5 хвилин» або натисни +5",
    "timer.unnamed": "Таймер",
    "timer.paused": "пауза",
    "timer.ringing": "Час!",
    "timer.pause": "Пауза",
    "timer.cancel": "Скасувати",
    "timer.done": "Час! {label}",
    "timer.doneSpoken": "Таймер «{label}» — час!",
    "weather.head": "Погода",
    "weather.failed": "не вдалося оновити",
    "weather.humidity": "вологість {n}%",
    "weather.wind": "вітер {n} км/год",
    "set.screens": "Екрани",
    "set.screens.hint": "що показує карусель і в якому порядку",
    "set.screens.up": "Вище",
    "set.screens.down": "Нижче",
    "set.screens.shown": "видно",
    "set.screens.hidden": "сховано",
    "set.screens.home": "дім",
    "set.weatherCity": "Місто погоди",
    "set.weatherCity.hint": "будь-яке інше — просто спитай бота",
    "city.kyiv": "Київ",
    "city.lviv": "Львів",
    "city.kharkiv": "Харків",
    "city.odesa": "Одеса",
    ...
    /* Субтитр під обличчям: коли зникає. «auto» тримає його весь час, поки
       бот читає репліку вголос, і ще 15 с після — щоб дочитати очима. */
    "set.caption": "Субтитр",
    "set.caption.hint": "коли зникає текст під обличчям",
    "set.caption.auto": "Сам, через 15 с після читання",
    "set.caption.manual": "Доки не закрию (✕)",
    "caption.close": "Закрити субтитр",
    "set.date": "Дата",
    ...
    "icons.white": "Монохромні",
    "icons.white.hint": "Білі на темній, темні на світлій",
    "icons.pack": "Pixel (з паку)",
    "icons.pack.hint": "Кольорові, як у лаунчері Pixel",
    "icons.auto": "Авто (за темою)",
    ...
    "store.badgeShared": "чуже",
    "store.sharedNote": "Пакет із файлу .cbp: працює в пісочниці, без мережі й без доступу до бота.",
    "store.share": "Поділитись",
    "store.delete": "Видалити",
    "store.deleteSure": "Точно?",
    "store.back": "До списку",
    "store.shareHint": "Файл пакета: {url}",
    "store.sendTo": "У {name}",
    "store.sent": "Надіслано",
    "store.cat.all": "Усі",
    "store.cat.games": "Ігри",
    "store.cat.tools": "Утиліти",
    "store.cat.media": "Медіа",
    "store.cat.health": "Здоровʼя",
    "store.cat.fun": "Розваги",
    "store.cat.system": "Система",
    "store.err.invalid_id": "Некоректний id пакета",
    "store.err.not_found": "Пакет не знайдено",
    "store.err.too_large": "Пакет завеликий",
    "store.err.bad_archive": "Файл .cbp пошкоджений або небезпечний",
    "store.err.bad_manifest": "Некоректний package.json",
    "store.err.id_taken": "Такий id уже має вбудований пакет",
    "store.err.io_error": "Помилка диска",
    "store.err.store_error": "Помилка магазину",

    /* ---- відео на екрані (команди бота) ---- */
    "video.needApp": "Спочатку встанови застосунок YouTube у магазині.",
    "video.nothing": "Зараз відео не грає.",
  ...
  en: {
    ...
    "voice.yes": "yes?",
    "voice.stopped": "okay, quiet",
    "voice.recognizing": "(recognizing…)",
    "voice.asrFail": "Recognition unavailable",
    "voice.asrOffline": "Bot is unreachable — speech not recognized",
    ...
    "busy.answering": "answering…",
    "busy.tool.weather": "checking the weather",
    "busy.tool.currency": "checking rates",
    "busy.tool.facts": "searching Wikipedia",
    "busy.tool.web_search": "searching the web",
    "busy.tool.image_search": "searching images",
    "busy.tool.memory_search": "searching memory",
    "busy.tool.workspace_info": "checking the workspace",
    "busy.tool.workspace_list": "listing a folder",
    "busy.tool.workspace_read": "reading a file",
    "busy.tool.workspace_write": "writing a file",
    "busy.tool.workspace_mkdir": "creating a folder",
    "busy.tool.workspace_delete": "moving to trash",
    "busy.tool.create_brain_file": "saving to memory",
    "busy.tool.create_brain_directory": "creating a memory section",
    "busy.tool.list_brain_navigation": "browsing memory",
    "speech.lang": "en-US",
    ...
    "quick.chatNew": "New chat",
    "quick.chatPick": "Switch chat",
    ...
    "timer.head": "Timer",
    "timer.empty": "Say “set a 5 minute timer” or tap +5",
    "timer.unnamed": "Timer",
    "timer.paused": "paused",
    "timer.ringing": "Time!",
    "timer.pause": "Pause",
    "timer.cancel": "Cancel",
    "timer.done": "Time! {label}",
    "timer.doneSpoken": "Timer “{label}” is done!",
    "weather.head": "Weather",
    "weather.failed": "could not update",
    "weather.humidity": "humidity {n}%",
    "weather.wind": "wind {n} km/h",
    "set.screens": "Screens",
    "set.screens.hint": "what the carousel shows, in what order",
    "set.screens.up": "Move up",
    "set.screens.down": "Move down",
    "set.screens.shown": "shown",
    "set.screens.hidden": "hidden",
    "set.screens.home": "home",
    "set.weatherCity": "Weather city",
    "set.weatherCity.hint": "for any other city, just ask the bot",
    "city.kyiv": "Kyiv",
    "city.lviv": "Lviv",
    ...
    "set.caption": "Caption",
    "set.caption.hint": "when the text under the face goes away",
    "set.caption.auto": "Itself, 15 s after reading",
    "set.caption.manual": "Until I close it (✕)",
    "caption.close": "Close caption",
    "set.date": "Date",
    ...
    "icons.white": "Monochrome",
    "icons.white.hint": "White on dark, dark on light",
    "icons.pack": "Pixel (icon pack)",
    "icons.pack.hint": "Full colour, like the Pixel launcher",
    "icons.auto": "Auto (follows theme)",
    ...
    "store.badgeShared": "shared",
    "store.sharedNote": "Installed from a .cbp file: runs sandboxed, offline, with no access to the bot.",
    "store.share": "Share",
    "store.delete": "Delete",
    "store.deleteSure": "Sure?",
    "store.back": "Back to list",
    "store.shareHint": "Package file: {url}",
    "store.sendTo": "To {name}",
    "store.sent": "Sent",
    "store.cat.all": "All",
    "store.cat.games": "Games",
    "store.cat.tools": "Tools",
    "store.cat.media": "Media",
    "store.cat.health": "Health",
    "store.cat.fun": "Fun",
    "store.cat.system": "System",
    "store.err.invalid_id": "Invalid package id",
    "store.err.not_found": "Package not found",
    "store.err.too_large": "Package too large",
    "store.err.bad_archive": "The .cbp file is broken or unsafe",
    "store.err.bad_manifest": "Invalid package.json",
    "store.err.id_taken": "A built-in package already uses this id",
    "store.err.io_error": "Disk error",
    "store.err.store_error": "Store error",

    "video.needApp": "Install the YouTube app from the store first.",
    "video.nothing": "No video is playing right now.",
